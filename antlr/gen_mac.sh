...
antlr -visitor Python3.g4 -package $package_base.python3 -o gen
mv gen/ ../../../$classpath/gen/python3
cd -

cd grammars/java/java

antlr -visitor JavaParser.g4 JavaLexer.g4 -package $package_base.java -o gen
mv gen/ ../../../$classpath/gen/java
cd -

cd grammars/cpp
antlr -visitor CPP14.g4 -package $package_base.cpp -o gen
