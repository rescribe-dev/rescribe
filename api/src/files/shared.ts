...
export const indexFile = async (location: StorageType, projectID: ObjectId, repositoryID: ObjectId, branchID: ObjectId, path: string, fileName: string, content: string): Promise<string> => {
